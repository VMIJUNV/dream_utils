...
class Model:
    ...
    def generate(self,messages,model_args = None,**kwargs):
        ...
        try:
            response['usage']['prompt_tokens']=completion.usage.prompt_tokens
            response['usage']['completion_tokens']=completion.usage.completion_tokens
            response['usage']['total_tokens']=completion.usage.total_tokens
        except:
        ...
        try:
            response['usage']['cached_tokens']=completion.usage.prompt_tokens_details.cached_tokens
        except:
            response['usage']['cached_tokens']=None
